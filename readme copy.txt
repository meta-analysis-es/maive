---
title: "MAIVE in R: Instructions to the User"
...
This readme provides instructions on the implementation of the MAIVE meta-analysis estimator in R: The `meta_maive` package with the `maive.R` function.

Spurious Precision in Meta-Analysis of Observational Research by Zuzana Irsova, Pedro R. D. Bom, Tomas Havranek, and Heiko Rachinger  
[https://meta-analysis.cz/maive](https://meta-analysis.cz/maive)
...
## Options
The user needs to specify the following options (with defaults in parentheses):
...
- If instrumenting SEs, a heteroskedasticity-robust F test of the first-stage regression.
- If AR option is chosen, an Anderson-Rubin confidence interval for weak instruments.
